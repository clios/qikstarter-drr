...
function MunicipalitiesCapacityBarChart({ data }) {
  return (
    <div>
      {data && (
        <VictoryChart
          ...
          <VictoryGroup offset={18}>
            ...
            <VictoryBar
              ...
              data={[
                { x: 'Aglipay', y: data?.total_capacity_government_aglipay || 0 },
                { x: 'Cabarroguis', y: data?.total_capacity_government_cabarroguis || 0 },
                { x: 'Diffun ', y: data?.total_capacity_government_diffun || 0 },
                { x: 'Maddela ', y: data?.total_capacity_government_maddela || 0 },
                { x: 'Nagtipunan', y: data?.total_capacity_government_nagtipunan || 0 },
                { x: 'Saguday', y: data?.total_capacity_government_saguday || 0 }
              ]}
            />
            {/* PRIVATE */}
            <VictoryBar
              ...
              data={[
                { x: 'Aglipay', y: data?.total_capacity_private_aglipay || 0 },
                { x: 'Cabarroguis', y: data?.total_capacity_private_cabarroguis || 0 },
                { x: 'Diffun ', y: data?.total_capacity_private_diffun || 0 },
                { x: 'Maddela ', y: data?.total_capacity_private_maddela || 0 },
                { x: 'Nagtipunan', y: data?.total_capacity_private_nagtipunan || 0 },
                { x: 'Saguday', y: data?.total_capacity_private_saguday || 0 }
              ]}
            />
          </VictoryGroup>
          <VictoryLegend
