...
function BridgeBarChart() {
  return (
    <div className="fcifbridgebc">
      <VictoryChart domainPadding={{ x: [50, 50], y: [16, 50] }}>
        <VictoryAxis label="32 Bridges" style={{ axisLabel: { fill: '#DF9C20', fontSize: 18, padding: -245 } }} />
