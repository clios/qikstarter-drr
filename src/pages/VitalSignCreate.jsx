...
function VitalSignCreate() {
  ...
  function submitForm(e) {
    ...
    const URL = process.env.BASE_URL + '/vitalSigns'
    const DATA = {
    ...
    axios
      ...
      .then((response) => {
        if (response.status === 201) {
          setStatus('success')
          toast.success('New vital sign record has been created')
    ...
    <PageContent>
      <FadeAnimation>
        <Form status={status}>
          ...
          <FormRow>
            <Field error={error.recorded_at} label="Date" status={status}>
              <Input onChange={(e) => setRecordedDate(e.target.value)} uppercase required type="date" value={recorded_date} />
            </Field>
            <Field error={error.recorded_at} label="Time" status={status}>
          ...
          <FormRow>
            ...
            <Field error={error.respiratory_rate} label="Respiratory Rate">
              <Cleave
            ...
            <Field error={error.pulse_rate} label="Pulse/Heart Rate">
              <Cleave
          ...
          <FormRow>
            <Field error={error.systolic} label="Blood Pressure">
              <Cleave
            ...
            <Field error={error.diastolic} label="Blood Pressure">
              <Cleave
...
export default VitalSignCreate
